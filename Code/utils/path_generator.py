...
def getBaseNamespaces(fn):
    ...
    This function takes a folder path such as: '../schemas/all/2018v1.0'. Looks for the common efile types and
    ...
    # Step 3. Declare full path where files are we will search i.e. ../schemas/all/2018v1.0/Common/efileTypes.xsd
...
def process(namespaces, xpref, fn):
    ...
    # ../schemas/all/2018v1.0/TEGE/Common/Dependencies/GeneralExplanationAttachment.xsd   -> turns into GeneralExplanationAttachment
    source = fn.split("/")[-1].split(".")[0]

    # Step 3. Set Version as path of file  example: ../schemas/all/2018v1.0 - turns into 2018v1.0
    version = fn.split("/")[3]
